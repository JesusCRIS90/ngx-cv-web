...
import { SideBarPopUpHostComponent, ToastHostComponent } from '@beexy/ngx-popups'
...
@Component({
  selector: 'app-root',
  imports: [ModalWindowHostComponent, SideBarPopUpHostComponent, ToastHostComponent, RouterOutlet, BeeScrollTrackerComponent],
